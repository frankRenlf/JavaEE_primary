...
//        copyFile(sourceFile, destFile);
        ...
        System.out.println("it can jump4");
    ...
    private static void receive(Scanner scanner, File destFile) {
        try (PrintWriter pw = new PrintWriter(new FileOutputStream(destFile), true, StandardCharsets.UTF_8)) {
            ...
            while (scanner.hasNextLine() && System.currentTimeMillis() - cur < 5) {
                pw.println(scanner.nextLine());
                pw.flush();
                System.out.println("it can jump1");
            }
//            if (System.currentTimeMillis() - cur > 5) {
//                return;
//            }
            System.out.println("it can jump2");
        } catch (FileNotFoundException e) {
            throw new RuntimeException(e);
        }
        System.out.println("it can jump3");
    }
